CREATE OR REPLACE FUNCTION acquire_calibration_lease_cas(
  p_model_key TEXT,
  p_owner_id TEXT,
  p_lease_token TEXT,
...
BEGIN
  ...
  VALUES(
    p_model_key,p_owner_id,p_lease_token,
  ...
  SET owner_id=EXCLUDED.owner_id,
      ...
      fencing_version=
        calibration_checkpoint_leases.fencing_version+1,
...
CREATE OR REPLACE FUNCTION renew_calibration_lease_cas(
  p_model_key TEXT,
  p_owner_id TEXT,
  p_lease_token TEXT,
  p_expected_version BIGINT,
...
BEGIN
  ...
  RETURN QUERY SELECT 'RENEWED',v_version;
END $$;
