function evaluate(input={}){
  ...
  if(!actor) return {state:"DENY",reason:"actor_required",phase:172};
  if(!action) return {state:"DENY",reason:"action_required",phase:172};
  if(!resource) return {state:"DENY",reason:"resource_required",phase:172};
