-- Verified atomic takeover primitive.
-- The caller must check the affected-row count before treating takeover as successful.

CREATE OR REPLACE FUNCTION takeover_expired_job(
  p_run_key TEXT,
